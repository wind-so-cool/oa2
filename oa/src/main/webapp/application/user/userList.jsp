...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 数据管理 <span class="c-gray en">&gt;</span> 用户管理 <span
        class="c-gray en">&gt;</span> 用户列表 <a class="btn btn-success radius r mr-20"
                                              style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i
        class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    <form action="/userController/getUserPage">
        <div class="text-c">
            <div class="row cl ">
                <div class="formControls col-3">
                    登录名: <input type="text" class="input-text" style="width: 250px" name="userName"
                                value="${user.userName}">
                </div>
                ...
                <div class="formControls col-5">
                    手机： <input type="text" class="input-text" style="width: 250px" name="mobilePhone"
 ...
 class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
            <shiro:hasPermission name="user:toAddUser">
            <a
            href="javascript:;" onclick="userAdd('添加用户','userController/toAddUser','800','650')"
        ...
        <c:forEach items="${page.list}" var="u">
            <tr class="text-c">
                ...
                <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')"
                        ...
                        onclick="userUpdate('用户编辑','userController/toUserUpdate/${u.userId}','800','650')" class="ml-5"
                        style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除"
                                                                                                 href="javascript:;"
                                                                                                 onclick="userDel('${u.userId}')"
                                                                                                 class="ml-5"
