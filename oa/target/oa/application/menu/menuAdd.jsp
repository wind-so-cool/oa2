...
%>
        ...
        <input type="text" class="input-text" value="" placeholder="" id="menuName" name="menuName" datatype="*"
        nullmsg="菜单名称不能为空" >
        </div>
        <div class="col-4"> </div>
        </div>
        ...
        <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="menuParentName" name="menuParentName"
         readonly datatype="*"
            nullmsg="父菜单名称不能为空">
        <input type="hidden" class="input-text" value="" placeholder="" id="menuParentId" name="menuParentId">
        ...
        submitForm(form,"menuController/addMenu");
        return false;
        }
        });
