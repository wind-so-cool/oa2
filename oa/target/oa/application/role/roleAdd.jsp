    ...
    <form action="" method="post" class="form form-horizontal" id="form-role-add">
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder=""  id="roleName" name="roleName" datatype="*" nullmsg="角色名称不能为空">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="roleDesc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)"></textarea>
    ...
    $(function () {
        ...
        $("#form-role-add").Validform({
            ...
            callback: function (form) {
                submitForm(form,"roleController/addRole");
                return false;
            }
        });
