...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-user-update">
      ...
      <%--  <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="password" placeholder="密码" autocomplete="off" value="${user.userName}" name="userPassword"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" placeholder="组织" autocomplete="off" value="${user.orgName}" id="orgParentName" name="orgName"
                       datatype="*" readonly class="input-text" nullmsg="组织不能为空">
                <input type="hidden" class="input-text" value="${user.orgId}" placeholder="" id="orgParentId" name="orgId">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" readonly datatype="*" value="<fmt:formatDate value="${user.userBirthday}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate>" name="userBirthday" placeholder="生日" nullmsg="生日不能为空"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${user.mobilePhone}" placeholder="" id="mobilePhone" name="mobilePhone"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" placeholder="@" name="email" value="${user.email}" id="email" datatype="e"
                       nullmsg="请输入邮箱！">
            </div>
            <div class="col-4"></div>
        </div>
    ...
    $(function () {
        ...
        $("#form-user-update").Validform({
            ...
            callback: function (form) {
                submitForm(form,"userController/updateUser");
                return false;
            }
        });
        CascadeArea("${user.provinceId}","${user.cityId}","${user.countryId}","provinceId","cityId","countryId")

        $(":radio[value='${user.userSex}']").prop("checked",true);
    });
</script>
</body>
</html>