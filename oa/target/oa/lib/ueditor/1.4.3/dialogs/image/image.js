            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        ...
                        $file.find('.error.jsp').text(json.state).show();
                    }
                } catch (e) {
                    $file.find('.error.jsp').text(lang.errorServerUpload).show();
                }
            });

            uploader.on('uploadError', function (file, code) {
            });
            uploader.on('error.jsp', function (code, file) {
