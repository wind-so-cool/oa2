...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    this.on('error.jsp', this.onError);
...
vjs.Player.prototype.error = function(){ return this.techGet('error.jsp'); };
...
vjs.LoadingSpinner = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    player.on('error.jsp', vjs.bind(this, this.show));
